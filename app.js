...
const I18N = {
  pl: {
    eyebrow: 'Platforma kursów',
    heroTitle: 'Ucz się tego, co dalej',
    heroSub:
      'Kilka kierunków, jeden format: każda lekcja na trzech poziomach, z diagramem i quizem. Postęp zapisuje się lokalnie.',
    yourProgress: 'Twój postęp',
    lessonsDone: (d, t) => `${d} z ${t} lekcji ukończonych`,
    tracksLabel: 'Kierunki',
    trackEyebrow: 'Kierunek',
    modulesLabel: 'Moduły',
    lessonsLabel: 'Lekcje',
    moduleCount: (n) => `${n} ${plural(n, 'moduł', 'moduły', 'modułów')}`,
    ...
    backHome: 'Kierunki',
    comingSoon: 'Wkrótce',
    comingSoonHint: 'Ten kierunek jest w przygotowaniu. Zajrzyj, co będzie w środku.',
    plannedLabel: 'Co będzie w kursie',
    plannedEmpty: 'Plan tego kierunku powstaje. Wróć tu za chwilę.',
    seePlan: 'Zobacz plan',
    levels: { eli5: 'Jak dziecku', school: 'Licealista', pro: 'Pro' },
    levelAria: 'Poziom wyjaśnienia',
    quizTitle: 'Quiz',
    quizIntro:
      'Odpowiedz na 4 pytania. Wynik 75% lub wyższy automatycznie zalicza lekcję.',
    quizProgress: (a, t) => `${a}/${t} odpowiedzi`,
    correct: 'Dobrze!',
    wrong: 'Niedokładnie',
    yourScore: 'Twój wynik',
    passed: 'Lekcja zaliczona. Świetna robota!',
    failed: 'Potrzebujesz 75%, żeby zaliczyć. Spróbuj jeszcze raz.',
    tryAgain: 'Spróbuj ponownie',
    markDone: 'Oznacz jako ukończona',
    markedDone: 'Ukończona',
    unmark: 'Cofnij ukończenie',
    prev: 'Poprzednia',
    next: 'Następna',
    notFoundTitle: 'Nie znaleziono',
    notFoundBody: 'Ta strona nie istnieje. Wróć na stronę główną.',
    noContentTitle: 'Brak treści',
    noContentBody:
      'Nie udało się załadować kierunków z katalogu content/. Sprawdź konsolę przeglądarki.',
    footer: 'Learn AI - statyczny kurs bez frameworków. Postęp zapisany lokalnie.',
    langAria: 'Język',
    ...
    interactiveHint: 'Przewijaj suwakiem lub strzałkami, żeby zobaczyć kolejne kroki.',
    frameOf: (i, n) => `Krok ${i} z ${n}`,
    framePrev: 'Poprzedni krok',
    frameNext: 'Następny krok',
    ...
    reviewDesc: 'Dzienna dawka pytań z lekcji, które już zaliczyłeś.',
    reviewModuleCta: 'Powtórz ten moduł',
    reviewScopeLabel: 'Zakres powtórki',
    reviewAll: 'Wszystko',
    reviewAllDesc: (n) =>
      `${n} ${plural(n, 'ukończona lekcja', 'ukończone lekcje', 'ukończonych lekcji')} we wszystkich kierunkach`,
    reviewPickModule: 'Albo jeden moduł',
    reviewModuleDone: (d, tt) => `${d}/${tt} ${plural(tt, 'lekcja', 'lekcje', 'lekcji')} zaliczone`,
    reviewEmptyTitle: 'Nie ma jeszcze czego powtarzać',
    reviewEmptyBody:
      'Zalicz najpierw dowolną lekcję (quiz 75% albo przycisk "Oznacz jako ukończona") i wróć tutaj.',
    reviewGoCourses: 'Przejdź do kierunków',
    reviewNoQuestions: 'Ukończone lekcje w tym zakresie nie mają pytań quizowych.',
    reviewPoolSmall: (n) =>
      `W tym zakresie jest tylko ${n} ${plural(n, 'pytanie', 'pytania', 'pytań')} - tyle liczy ta sesja.`,
    reviewSessionIntro:
      'Jedno pytanie naraz. Błędne wraca jeszcze w tej sesji, dobre - dopiero za jakiś czas.',
    reviewDue: (n) => `Powtórki na dziś: ${n}`,
    ...
    reviewEndlessHint: 'Rundy po 10 pytań, tak długo jak chcesz.',
    reviewMore: 'Jeszcze 10',
    reviewStop: 'Koniec',
    reviewNewCard: 'nowa',
    reviewAgainCard: 'jeszcze raz',
    reviewRequeued: 'To pytanie wróci jeszcze w tej sesji.',
    reviewBackIn: (n) =>
      n <= 0
        ? 'Wróci jeszcze dziś.'
        : n === 1
        ? 'Wróci jutro.'
        : `Wróci za ${n} ${plural(n, 'dzień', 'dni', 'dni')}.`,
    reviewAllDoneTitle: 'Wszystko powtórzone na dziś',
    reviewAllDoneBody:
      'Żadne pytanie nie czeka dziś na powtórkę. Jeśli masz ochotę, ćwicz dalej bez limitu.',

    /* -- v6: fiszki w SRS + mikro-sesja -- */
    termCard: 'fiszka',
    termPrompt: 'Co to znaczy?',
    termReveal: 'Pokaż odpowiedź',
    termKnew: 'Umiałem',
    termMissed: 'Nie umiałem',
    termRequeued: 'Ta fiszka wróci jeszcze w tej sesji.',
    quickTitle: 'Mam 5 minut',
    quickCta: 'Mam 5 minut',
    quickDesc: 'Pięć kart powtórki albo najkrótsza nieukończona lekcja.',
    ...
    preguessHint:
      'Jedno pytanie z tej lekcji. Nie liczy się do wyniku ani do powtórek - chodzi o samo zgadywanie.',
    preguessAfter: 'Teraz przeczytaj lekcję i sprawdź się.',
    feynmanTitle: 'Wyjaśnij własnymi słowami',
    feynmanDesc:
      'Napisz to tak, jakbyś tłumaczył koledze z zespołu. Na telefonie możesz dyktować klawiaturą.',
    feynmanPlaceholder: 'O co tu chodzi? Wyjaśnij to własnymi słowami...',
    feynmanCompare: 'Porównaj z wersją prostą',
    feynmanHide: 'Ukryj wersję prostą',
    feynmanGap: 'Czego zabrakło?',
    feynmanGapHint:
      'Porównaj oba teksty: które pojęcia są w wersji prostej, a nie ma ich w twoim opisie?',
    feynmanSaved: 'Zapisano ✓',
    feynmanSaving: 'Zapisuję...',
    feynmanAria: 'Twoje wyjaśnienie tej lekcji',
    askClaude: '💬 Zapytaj Claude o tę lekcję',
    askClaudePrompt: (lesson, track, mod) =>
      `Uczę się tematu "${lesson}" (kurs ${track}, moduł ${mod}). Wyjaśnij mi to inaczej niż standardowo, sprawdź moje zrozumienie 2-3 pytaniami i podaj jeden praktyczny przykład z frontendu.`,

    /* -- v5: rozmowa rekrutacyjna -- */
    interviewTitle: 'Rozmowa rekrutacyjna',
    interviewDesc: 'Trudniejsze pytania - zamknięte i otwarte, jak na prawdziwej rozmowie.',
    interviewScopeLabel: 'Z jakiego kierunku pytamy?',
    interviewAll: 'Wszystkie kierunki',
    interviewAllDesc: (n) => `${n} ${plural(n, 'pytanie', 'pytania', 'pytań')} w puli`,
    interviewBankSize: (n) => `${n} ${plural(n, 'pytanie', 'pytania', 'pytań')}`,
    interviewEmptyTitle: 'Brak pytań',
    interviewEmptyBody: 'Baza pytań rekrutacyjnych nie jest jeszcze gotowa. Zajrzyj później.',
    interviewSessionIntro:
      'Dziesięć pytań. Przy pytaniach otwartych najpierw odpowiedz sobie na głos, potem odsłoń wzorzec.',
    interviewOpenQ: 'Pytanie otwarte',
    interviewChoiceQ: 'Pytanie zamknięte',
    interviewShow: 'Pokaż odpowiedź',
    interviewModelAnswer: 'Wzorcowa odpowiedź',
    interviewKeyPoints: 'Na to czeka rekruter',
    interviewKnew: 'Umiałem',
    interviewRepeat: 'Muszę powtórzyć',
    interviewChoiceScore: (r, n) => `Zamknięte: ${r}/${n} poprawnych`,
    interviewOpenTally: (ok, again) => `Otwarte: ${ok} umiane, ${again} do powtórki`,
    interviewNoOpen: 'Brak pytań otwartych w tej sesji.',
    interviewNoChoice: 'Brak pytań zamkniętych w tej sesji.',
    levelMid: 'mid',
    levelSenior: 'senior',
    sessionQuestions: (n) => `${n} ${plural(n, 'pytanie', 'pytania', 'pytań')}`,
    ...
    searchHint:
      'Minimum 2 znaki. Przeszukujemy tytuły i treść wszystkich trzech poziomów, po polsku i po angielsku.',
    searchTooShort: 'Wpisz co najmniej 2 znaki.',
    searchResults: (n) => `${n} ${plural(n, 'wynik', 'wyniki', 'wyników')}`,
    searchCapped: (n) => `Pokazujemy pierwsze ${n}.`,
    searchEmpty: 'Nic nie pasuje. Spróbuj innego słowa.',
    streakTitle: 'Seria',
    streakValue: (n) => `${n} ${plural(n, 'dzień', 'dni', 'dni')} 🔥`,
    streakNone: 'Zacznij dziś swoją serię 🔥',
    goalToday: (x, g) => `Dziś: ${x} / cel ${g}`,
    goalDone: 'Cel dnia zrobiony ✓',
    goalHint: 'Jedna zaliczona lekcja albo skończona sesja = jeden punkt.',
    statsTitle: 'Statystyki',
    statsLink: 'Statystyki',
    statsDesc: 'Gdzie jest najsłabiej i jak regularnie się uczysz.',
    statsWeakTitle: 'Najsłabsze obszary',
    statsWeakHint:
      'Liczymy je z powtórek: im niższe pudełko i więcej wpadek, tym słabszy moduł. Do rankingu wchodzą moduły z co najmniej 3 zaplanowanymi kartami.',
    statsWeakEmpty:
      'Za mało danych. Zrób kilka powtórek - ranking pojawi się, gdy jakiś moduł będzie miał co najmniej 3 zaplanowane karty.',
    ...
    statsWeakScore: (p) => `słabość ${p}%`,
    statsReviewModule: 'Powtórz ten moduł',
    statsHeatTitle: 'Aktywność',
    statsHeatHint: 'Ostatnie 16 tygodni. Jeden punkt = zaliczona lekcja albo skończona sesja.',
    statsHeatSummary: (points, days) =>
      `${points} ${plural(points, 'punkt', 'punkty', 'punktów')} w ${days} ${plural(
        days,
        'dniu',
        'dniach',
        'dniach'
    ...
    statsHeatLess: 'mniej',
    statsHeatMore: 'więcej',
    statsHeatToday: 'dziś',
    statsCellAria: (day, n) =>
      `${day}: ${n} ${plural(n, 'punkt', 'punkty', 'punktów')}`,
    statsWeekdays: ['pon', 'wt', 'śr', 'czw', 'pt', 'sob', 'ndz'],
    statsMonths: ['sty', 'lut', 'mar', 'kwi', 'maj', 'cze', 'lip', 'sie', 'wrz', 'paź', 'lis', 'gru'],
    weakChipLabel: (name) => `Najsłabszy obszar: ${name}`,
    weakChipCta: 'Powtórz',
    glossaryTitle: 'Słowniczek',
    glossaryLink: 'Słowniczek',
    glossaryDesc:
      'Wszystkie pojęcia ze wszystkich kierunków, alfabetycznie. Szukaj i wracaj do lekcji źródłowej.',
    glossaryPlaceholder: 'Szukaj pojęcia...',
    glossaryAria: 'Szukaj w słowniczku',
    glossaryTooShort: 'Wpisz co najmniej 2 znaki, żeby filtrować.',
    glossaryEmpty: 'Żadne pojęcie nie pasuje.',
    glossaryCount: (n) => `${n} ${plural(n, 'pojęcie', 'pojęcia', 'pojęć')}`,
    glossaryFiltered: (n, total) => `${n} z ${total}`,
    glossaryNone: 'W treści nie ma jeszcze żadnych pojęć.',
    termsLabel: 'Pojęcia w tej lekcji',
    termChipAria: (term) => `Pokaż definicję: ${term}`,
    termMarkAria: (term) => `Pojęcie: ${term}. Pokaż definicję.`,
    defSheetAria: 'Definicja pojęcia',
    defSheetClose: 'Zamknij',
    defSheetSource: 'Lekcja źródłowa',
    dataTitle: 'Kopia postępu',
    dataDesc: 'Zapisz postęp do pliku albo przenieś go na inne urządzenie kodem.',
    dataExport: '⬇ Eksportuj',
    dataCodeLabel: 'Kod postępu',
    dataCopied: 'Plik pobrany, kod skopiowany do schowka.',
    dataCopyFailed: 'Plik pobrany. Kod masz w polu obok - skopiuj go ręcznie.',
    dataPasteLabel: 'Wklej kod albo wybierz plik',
    dataPastePlaceholder: 'Wklej tutaj kod postępu...',
    dataPickFile: '📄 Wybierz plik',
    dataCheck: 'Sprawdź dane',
    dataBad: 'Nie rozpoznaję tych danych. Wklej kod z eksportu albo wybierz plik learnai-progress.json.',
    dataPreview: (n, when) =>
      `${n} ${plural(n, 'ukończona lekcja', 'ukończone lekcje', 'ukończonych lekcji')}, zapis z ${when}.`,
    dataConfirmQ: 'Nadpisać obecny postęp tymi danymi?',
    dataConfirm: 'Nadpisz postęp',
    dataCancel: 'Anuluj',
    dataImported: 'Postęp wczytany.',
  },
  en: {
