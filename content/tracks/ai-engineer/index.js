...
export default {
  ...
  description: {
    pl: 'Kompletna sciezka od seniora frontendu do inzyniera AI: LLM, structured output, RAG, agenci, evale, streaming UX, bezpieczenstwo i Python.',
    en: 'The complete path from senior frontend to applied AI: LLMs, structured output, RAG, agents, evals, streaming UX, security and Python.',
  },
  modules,
  planned: [],
};
